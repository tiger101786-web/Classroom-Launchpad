...
(async()=>{
 const ids=['sasuke','madara','kakashi','sakura'];
 ...
 const configs=[{enabled:true,theme:'anime-spirit',slots:['sasuke','madara','kakashi']},{enabled:true,theme:'anime-spirit',slots:['kakashi','sakura','sasuke']}];
 ...
 console.log('All four Naruto busts validate and render.');
