...
assert.match(app, /drawSelectPreview\(selectMrsLevandoskeCanvas, getMrsLevandoskeIdleVideo\(\), 143, 218, -7\)/, "Mrs. Levandoske should be enlarged proportionally and sit slightly lower on the character-select platform.");
...
assert.match(app, /drawSelectPreview\(selectMrsTrittelCanvas, getMrsTrittelIdleVideo\(\), 143, 218, 0\)/, "Mrs. Trittel must be enlarged while preserving her natural video proportions.");
assert.match(app, /drawSelectPreview\(selectMrsKochCanvas, getMrsKochIdleVideo\(\), 143, 218, -5\)/, "Mrs. Koch must be enlarged while preserving her natural video proportions and lower platform position.");
assert.match(
  styles,
