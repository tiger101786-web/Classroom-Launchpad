...
const homeSceneIds = new Set(["original", "reef", "forest", "pixel", "observatory", "dragon", "cabin", "neon", "castle", "koi", "crystal", "pumpkin", "volcano", "football", "basketball", "championship", "soccer", "baseball", "softball", "gymnastics", "cafe", "aurora", "train", "lantern", "bookshop", "crawfish", "balloons", "robotics", "retro-arcade"]);
